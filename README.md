...
```
![default fit](https://github.com/segsell/kernreg/blob/master/docs/images/motorcycle_default_fit.png?raw=true)
...
```
![user fit](https://github.com/segsell/kernreg/blob/master/docs/images/motorcycle_user_fit.png?raw=true)
